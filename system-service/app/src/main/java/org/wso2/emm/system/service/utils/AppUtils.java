...
import static android.content.pm.PackageManager.INSTALL_FAILED_THEME_AAPT_ERROR;
import static android.content.pm.PackageManager.INSTALL_FAILED_THEME_IDMAP_ERROR;
import static android.content.pm.PackageManager.INSTALL_FAILED_THEME_UNKNOWN_ERROR;
...
public class AppUtils {
    ...
    public static void silentInstallApp(final Context context, Uri packageUri) {
        Log.d(TAG, "silentInstallApp: actual installation");

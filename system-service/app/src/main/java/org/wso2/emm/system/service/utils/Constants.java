...
public class Constants {
	...
	public static final String AGENT_APP_PACKAGE_NAME = "org.wso2.iot.agent";
	public static final String PACKAGE_NAME = "org.wso2.iot.system.service";
	public static final String AGENT_APP_LAUNCH_ACTIVITY = "ServerDetails";
	public static String DEFAULT_OTA_SERVER_ADDRESS = "dev.sf.vfcarbon.com";
	public static final String DEFAULT_OTA_SERVER_PROTOCOL = "https";
	public static final String DEFAULT_OTA_SERVER_SUB_DIRECTORY = "ota";
	public static final int DEFAULT_OTA_SERVER_PORT = 443;
	...
	public static final int FIRMWARE_DOWNLOAD_TIMEOUT = 24*60*60*1000;

	/**
	 * Read_TIMEOUT = SO timeout(the time since the last byte has been received)
	 */
	public static final int FIRMWARE_UPGRADE_READ_TIMEOUT = 30000;

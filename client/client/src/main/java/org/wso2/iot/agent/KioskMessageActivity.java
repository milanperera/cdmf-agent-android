 ...
 */
public class KioskMessageActivity extends Activity {
	...
	private static final String TAG = KioskMessageActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = KioskMessageActivity.this.getApplicationContext();
		...
		btnOK.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (DEVICE_OPERATION_RING.equalsIgnoreCase(type)) {
					stopRing();
					KioskMessageActivity.this.finish();
